...
<nav>
	<ul>
		...
		<!--Code injected by: ClimateControlResource-AlterIndex-->
		<li><a title="Temperatura" href="http://localhost:8080/temperatura">Temperatura</a></li>
		<!--Code injected by: ClimateControlResource-AlterIndex-->
...
<!--BCP-farm-name-->
Bienvenido a la granja Agrofarm<!--ECP-farm-name-->
</body>
</html>